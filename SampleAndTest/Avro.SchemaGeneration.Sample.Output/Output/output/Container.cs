...
namespace Avro.SchemaGeneration.Sample.Model
{
	...
	public partial class Container : global::Avro.Specific.ISpecificRecord
	{
		...
		public virtual object Get(int fieldPos)
		{
			switch (fieldPos)
			{
			case 0: return this.ContainerName;
			case 1: return this.PartitionKey;
		...
		public virtual void Put(int fieldPos, object fieldValue)
		{
			switch (fieldPos)
			{
			case 0: this.ContainerName = (System.String)fieldValue; break;
			case 1: this.PartitionKey = (System.String)fieldValue; break;
